 ...
 * 
 * @package   Profisme
 * @copyright Copyright (c) 2020, WordPress Theme Review Team
 ...
 */
function profisme_sanitize_css( $css ) {
 ...
 */
function profisme_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function profisme_sanitize_email( $email, $setting ) {
 ...
 */
function profisme_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function profisme_sanitize_html( $html ) {
 ...
 */
function profisme_sanitize_image( $image, $setting ) {
 ...
 */
function profisme_sanitize_nohtml( $nohtml ) {
 ...
 */
function profisme_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function profisme_sanitize_number_range( $number, $setting ) {
 ...
 */
function profisme_sanitize_select( $input, $setting ) {
 ...
 */
function profisme_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function profisme_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function profisme_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}